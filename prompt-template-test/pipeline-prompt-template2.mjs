...
// Example: reuse "persona + context" blocks for a quarterly OKR review email.

// 1) Task block for this scenario.
...
// 2) Format block for this scenario.
...
// 3) Compose the final prompt with PipelinePromptTemplate.
...
// 4) Example: build a prompt for one quarterly OKR review.
...
console.log('Quarterly OKR review email prompt:\n');
