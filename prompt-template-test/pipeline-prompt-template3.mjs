...
// A. Task block for this scenario.
...
// B. Format block for this scenario.
...
// C. Final ChatPromptTemplate receiving pipeline-assembled blocks.
...
const weeklyChatPipelinePrompt = new PipelinePromptTemplate({
  pipelinePrompts: [
    { name: 'persona_block', prompt: personaPrompt }, // Reuse persona block.
    { name: 'context_block', prompt: contextPrompt }, // Reuse context block.
    { name: 'task_block', prompt: weeklyTaskPrompt }, // Task block in this file.
    { name: 'format_block', prompt: weeklyFormatPrompt }, // Format block in this file.
  ],
  // Here finalPrompt is ChatPromptTemplate, not PromptTemplate.
...
// E. Example: build chat messages and feed them to the model.
...
console.log('Pipeline + ChatPromptTemplate generated messages:');
const messages = promptValue.toChatMessages();
console.log(messages);

// const aiResponse = await model.invoke(messages);
// console.log('\nAI generated weekly report content:');
